...
! ................................
   ...
   ! bgc constant
      ...
      d_con_g21_CO2      = 0.1325_r8
      d_con_g22_CO2      = 0.0009_r8
      d_con_w21_CO2      = 0.939_r8
      d_con_w22_CO2      = 0.02671_r8
      d_con_w23_CO2      = 0.0004095_r8
...
!END plant hydraulic variables
               ...
               ,al3_conc_vr(:,i), al2_conc_vr(:,i), al_conc_vr(:,i), ANC_conc_vr(:,i) &
               ,h2co3_conc_vr(:,i),hco3_conc_vr(:,i),co3_conc_vr(:,i) & 
               ,nh4_conc_vr(:,i), no3_conc_vr(:,i), h_from_N(:,i) &
               ,pH_init_vr(:,i), CEC(:,i), E_Bc(:,i), calcite_content(:,i) &
               ,rate_cal(:,i), rate_CO2(:,i), rate_Bcex(:,i), rate_Hex(:,i), pCO2_soil(:,i), pCO2_hr(:,i), calcite_mass(:,i) &
               ,h_conc_vr(:,i), oh_conc_vr(:,i), DIC_conc_vr(:,i), ca_conc_vr(:,i), Bc_conc_vr(:,i), Bct_conc_vr(:,i) &
               ,h_conc_m1(:,i), oh_conc_m1(:,i), ca_conc_m1(:,i), Bc_conc_m1(:,i), DIC_conc_m1(:,i) &
