...
!End plant hydraulic parameter
                     ...
                     ,al3_conc_vr, al2_conc_vr, al_conc_vr, ANC_conc_vr &
                     ,h2co3_conc_vr,hco3_conc_vr,co3_conc_vr & 
                     ,nh4_conc_vr, no3_conc_vr, h_from_N &
                     ,pH_init_vr, CEC, E_Bc, calcite_content &
                     ,rate_cal, rate_CO2, rate_Bcex, rate_Hex, pCO2_soil, pCO2_hr, calcite_mass &
                     ,h_conc_vr, oh_conc_vr, DIC_conc_vr, ca_conc_vr, Bc_conc_vr, Bct_conc_vr &
...
!=======================================================================
   ...
   real(r8), intent(in) :: pH_init_vr(1:nl_soil), CEC(1:nl_soil), E_Bc(1:nl_soil), calcite_content(1:nl_soil)
#endif
...
!#endif
   ...
   real(r8),intent(out) ::      &
        ...
        al_conc_vr               (nl_soil)                   , &
        ANC_conc_vr               (nl_soil)                   , &
        h2co3_conc_vr             (nl_soil)                   , &  
        hco3_conc_vr              (nl_soil)                   , &
        co3_conc_vr               (nl_soil)                   , &
        nh4_conc_vr               (nl_soil)                   , & 
        no3_conc_vr               (nl_soil)                   , &
        h_from_N                  (nl_soil)                   , &
