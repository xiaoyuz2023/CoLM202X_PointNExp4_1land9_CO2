...
ENDIF
         ...
         CALL write_history_variable_2d ( DEF_hist_vars%er , &
             a_er, file_hist, 'f_er', itime_in_file, sumarea, filter, &
             'total ecosystem respiration','gC/m2/s')

         ! soil respiration, autotrophic + heterotrophic
         CALL write_history_variable_2d ( DEF_hist_vars%soil_er , &
             a_soil_er, file_hist, 'f_soil_er', itime_in_file, sumarea, filter, &
             'soil respiration','gC/m2/s')
        ...
        CALL write_history_variable_2d ( DEF_hist_vars%vf, &
         ...
         ! mineral no3 density in soil layers
         CALL write_history_variable_3d ( DEF_hist_vars%smin_no3_vr, &
            a_smin_no3_vr, file_hist, 'f_smin_no3_vr', itime_in_file, 'soil', 1, nl_soil, &
            sumarea, filter,'mineral no3 density in soil layers','gN/m3')
         
         ! mineral nh4 density in soil layers
         CALL write_history_variable_3d ( DEF_hist_vars%smin_nh4_vr, &
            a_smin_nh4_vr, file_hist, 'f_smin_nh4_vr', itime_in_file, 'soil', 1, nl_soil, &
            sumarea, filter,'mineral nh4 density in soil layers','gN/m3')
         
         IF (DEF_USE_SOILACIDIFICATION) THEN
            ! pH in soil layers
            CALL write_history_variable_3d ( DEF_hist_vars%pH_vr, &
               a_pH_vr, file_hist, 'f_pH_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'pH in soil layers','-')

            CALL write_history_variable_3d ( DEF_hist_vars%pH_init_vr, &
               a_pH_init_vr, file_hist, 'f_pH_init_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'Init pH in soil layers','-')

            ! CALL write_history_variable_3d ( DEF_hist_vars%calcite_mass, &
            !    a_calcite_mass, file_hist, 'f_calcite_mass', itime_in_file, 'soil', 1, nl_soil, &
            !    sumarea, filter,'calcite_mass in soil layers','kg/m2')

            CALL write_history_variable_3d ( DEF_hist_vars%calcite_content, &
               a_calcite_content, file_hist, 'f_calcite_content', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'calcite_content in soil layers','%')

            CALL write_history_variable_3d ( DEF_hist_vars%h_from_N, &
               a_h_from_N, file_hist, 'f_h_from_N', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'h_from_N in soil layers','mol/l/s')

            CALL write_history_variable_3d ( DEF_hist_vars%rate_cal, &
               a_rate_cal, file_hist, 'f_rate_cal', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'rate_cal in soil layers','mol/l/s')

            CALL write_history_variable_3d ( DEF_hist_vars%rate_CO2, &
               a_rate_CO2, file_hist, 'f_rate_CO2', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'rate_CO2 in soil layers','mol/l/s')

            CALL write_history_variable_3d ( DEF_hist_vars%rate_Bcex, &
               a_rate_Bcex, file_hist, 'f_rate_Bcex', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'rate_Bcex in soil layers','mol/l/s')

            CALL write_history_variable_3d ( DEF_hist_vars%rate_Hex, &
               a_rate_Hex, file_hist, 'f_rate_Hex', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'rate_Hex in soil layers','mol/l/s')

            CALL write_history_variable_3d ( DEF_hist_vars%pCO2_soil, &
               a_pCO2_soil, file_hist, 'f_pCO2_soil', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'pCO2_soil in soil layers','ppmv')

            CALL write_history_variable_3d ( DEF_hist_vars%E_Bc, &
               a_E_Bc, file_hist, 'f_E_Bc', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'E_Bc in soil layers','%')

            CALL write_history_variable_3d ( DEF_hist_vars%CEC, &
               a_CEC, file_hist, 'f_CEC', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'CEC in soil layers','cmol(+)/kg')

               CALL write_history_variable_3d ( DEF_hist_vars%h_conc_vr, &
               a_h_conc_vr, file_hist, 'f_h_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'h_conc_vr in soil layers','mol/l')
               
            CALL write_history_variable_3d ( DEF_hist_vars%ca_conc_vr, &
               a_ca_conc_vr, file_hist, 'f_ca_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'ca_conc_vr in soil layers','mol/l')

            CALL write_history_variable_3d ( DEF_hist_vars%DIC_conc_vr, &
               a_DIC_conc_vr, file_hist, 'f_DIC_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'DIC_conc_vr in soil layers','mol/l')

            CALL write_history_variable_3d ( DEF_hist_vars%ANC_conc_vr, &
               a_ANC_conc_vr, file_hist, 'f_ANC_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'ANC_conc_vr in soil layers','mol/l')

            CALL write_history_variable_3d ( DEF_hist_vars%Bc_conc_vr, &
               a_Bc_conc_vr, file_hist, 'f_Bc_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'Bc_conc_vr in soil layers','mol/l')

            CALL write_history_variable_3d ( DEF_hist_vars%Bct_conc_vr, &
               a_Bct_conc_vr, file_hist, 'f_Bct_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'Bct_conc_vr in soil layers','mol/l')

            CALL write_history_variable_3d ( DEF_hist_vars%al3_conc_vr, &
               a_al3_conc_vr, file_hist, 'f_al3_conc_vr', itime_in_file, 'soil', 1, nl_soil, &
               sumarea, filter,'al3_conc_vr in soil layers','mol/l')
