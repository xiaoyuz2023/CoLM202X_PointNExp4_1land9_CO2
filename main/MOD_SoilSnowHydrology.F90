...
!-----------------------------------------------------------------------
   SUBROUTINE WATER_VSF (ipatch, patchtype,is_dry_lake, lb, nl_soil, deltim   ,&
              ...
              wdsrf       ,wa          ,wetwat      ,&
              forc_pco2m     ,pH_vr          ,pH_init_vr  ,E_Bc, h_conc_vr    ,&
              oh_conc_vr     ,ca_conc_vr     ,Bc_conc_vr  ,Bct_conc_vr        ,&
              al3_conc_vr   ,al2_conc_vr   ,al_conc_vr                     ,&
...
!-------------------------- Dummy Arguments ----------------------------
   ...
   real(r8), intent(inout) :: &
        pH_vr(1:nl_soil)        , &
        pH_init_vr(1:nl_soil)   , &
        E_Bc(1:nl_soil)         , &
        h_conc_vr(1:nl_soil)    , &
        oh_conc_vr(1:nl_soil)   , &
        ca_conc_vr(1:nl_soil)   , &
        Bc_conc_vr(1:nl_soil)   , &
        Bct_conc_vr(1:nl_soil)  , &
        al3_conc_vr(1:nl_soil)  , &
        al2_conc_vr(1:nl_soil)  , &
        al_conc_vr(1:nl_soil)   , &
        DIC_conc_vr(1:nl_soil)  , &
        h2co3_conc_vr(1:nl_soil), &
        hco3_conc_vr(1:nl_soil) , &
        co3_conc_vr(1:nl_soil)  , &
        h_conc_m1(1:nl_soil)    , &
        oh_conc_m1(1:nl_soil)   , &
        ca_conc_m1(1:nl_soil)   , &
        Bc_conc_m1(1:nl_soil)   , &
        DIC_conc_m1(1:nl_soil)
...
!=======================================================================
      ...
      CALL soil_water_vertical_movement ( &
         ...
         t_soisno(1:nl_soil), wice_soisno(1:nl_soil), forc_pco2m, pH_vr(1:nl_soil), pH_init_vr(1:nl_soil), E_Bc(1:nl_soil), &
         h_conc_vr(1:nl_soil), oh_conc_vr(1:nl_soil), ca_conc_vr(1:nl_soil),Bc_conc_vr(1:nl_soil),&
         Bct_conc_vr(1:nl_soil), al3_conc_vr(1:nl_soil), al2_conc_vr(1:nl_soil),al_conc_vr(1:nl_soil), &
         DIC_conc_vr(1:nl_soil), h2co3_conc_vr(1:nl_soil), hco3_conc_vr(1:nl_soil), co3_conc_vr(1:nl_soil), &
         h_conc_m1(1:nl_soil), oh_conc_m1(1:nl_soil), ca_conc_m1(1:nl_soil), Bc_conc_m1(1:nl_soil), DIC_conc_m1(1:nl_soil) )
