...
#ifdef BGC
    USE MOD_BGC_Vars_TimeVariables, only: pH_vr, pH_init_vr, E_Bc, h_conc_vr, oh_conc_vr, ca_conc_vr, Bc_conc_vr,&
            ...
            DO k = 1, steps_in_one_deltim
             ...
             ! additional variables required by coupling with WRF model
               ...
               fm(i),           fh(i),           fq(i),                            &                             
                ...
                ! variables of soil acidification
               pH_vr(1:,i), pH_init_vr(1:,i), E_Bc(1:,i), h_conc_vr(1:,i), oh_conc_vr(1:,i), &
               ca_conc_vr(1:,i), Bc_conc_vr(1:,i), Bct_conc_vr(1:,i),&
               al3_conc_vr(1:,1), al2_conc_vr(1:,1), al_conc_vr(1:,1), &
               DIC_conc_vr(1:,i), h2co3_conc_vr(1:,i), hco3_conc_vr(1:,i), co3_conc_vr(1:,i), &
               h_conc_m1(1:,i), oh_conc_m1(1:,i), ca_conc_m1(1:,i), Bc_conc_m1(1:,i), DIC_conc_m1(1:,i))
