...
SUBROUTINE CoLMMAIN ( &
         ...
         ! variables for soil acidification
           pH_vr, pH_init_vr, E_Bc, h_conc_vr, oh_conc_vr, ca_conc_vr, Bc_conc_vr, &
...
!  irrigation variables
         ...
         ELSE
            ...
            CALL WATER_VSF (ipatch ,patchtype,is_dry_lake,   lb          ,nl_soil           ,&
                 ...
                 wa                ,wetwat            ,&
                 forc_pco2m        ,pH_vr             ,pH_init_vr        ,E_Bc              ,& 
