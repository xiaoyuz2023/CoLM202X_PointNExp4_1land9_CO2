...
!------------------------- BGC constant --------------------------------------
   ...
   real(r8) :: d_con_g21_CO2                  ! CO2 diffusivity constants in gas (cm2 s-1)
   real(r8) :: d_con_g22_CO2                  ! CO2 diffusivity constants in gas (cm2 s-1)
   real(r8) :: d_con_w21_CO2                  ! CO2 diffusivity constants in water (cm2 s-1)
   real(r8) :: d_con_w22_CO2                  ! CO2 diffusivity constants in water (cm2 s-1)
   real(r8) :: d_con_w23_CO2                  ! CO2 diffusivity constants in water (cm2 s-1)
...
! bgc constants
 ...
 !     CALL ncio_read_vector       (file_restart, 'peatf_lf       ', landpatch, peatf_lf      )
      ...
      CALL ncio_read_bcast_serial (file_restart, 'd_con_g21_CO2       ', d_con_g21_CO2       )
      CALL ncio_read_bcast_serial (file_restart, 'd_con_g22_CO2       ', d_con_g22_CO2       )
      CALL ncio_read_bcast_serial (file_restart, 'd_con_w21_CO2       ', d_con_w21_CO2       )
      CALL ncio_read_bcast_serial (file_restart, 'd_con_w22_CO2       ', d_con_w22_CO2       )
      CALL ncio_read_bcast_serial (file_restart, 'd_con_w23_CO2       ', d_con_w23_CO2       )
 ...
 ! bgc constants
         ...
         CALL ncio_write_serial (file_restart, 'd_con_g21_CO2       ', d_con_g21_CO2       )
         CALL ncio_write_serial (file_restart, 'd_con_g22_CO2       ', d_con_g22_CO2       )
         CALL ncio_write_serial (file_restart, 'd_con_w21_CO2       ', d_con_w21_CO2       )
         CALL ncio_write_serial (file_restart, 'd_con_w22_CO2       ', d_con_w22_CO2       )
         CALL ncio_write_serial (file_restart, 'd_con_w23_CO2       ', d_con_w23_CO2       )
