...
! bgc variables
   ...
   real(r8), allocatable :: froot_mr_vr_p                (:,:) ! pft level vertical resolved: fine root maintenance respiration (gC m-3 s-1)
   ...
   real(r8), allocatable :: rr_p                         (:) ! pft level: root respiration (fine root MR + total root GR) (gC m-2 s-1)
...
!-----------------------------------------------------------------------
 ...
 ! bgc variables
            ...
            allocate (froot_mr_vr_p  (nl_soil,numpft)); froot_mr_vr_p(:,:) = spval
